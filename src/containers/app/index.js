    ...
    return (
      <div className={classes.root}>
        ...
        >
          ...
          <Divider />
          <List>
            <Link className={classes.link} key={Math.random()} to="/tables">
              <ListItem button>
                <ListItemIcon>
                  <GroupIcon />
                </ListItemIcon>
...
const routedComp = withRouter( connect( null, { loadMenuConnect: loadMenu } )( App ) );
export default withRoot( withStyles( styles, { withTheme: true } )( routedComp ) );

// const routedComp = withRouter( App );
// export default withRoot( withStyles( styles, { withTheme: true } )( routedComp ) );
